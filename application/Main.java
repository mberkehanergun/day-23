            ...
            loginButton.setOnAction(event -> {
                ...
                if (loginFail == false && ifNotExit == true) {
                    ...
                    companySettingsButton.setOnAction(companySettingsEvent -> {
                        ...
                        settingsLayout.getChildren().addAll(resultLabel, createTableButton1, dropTableButton1, createTableButton2, dropTableButton2, createTableButton3, dropTableButton3, createTableButton4, dropTableButton4, fillTableButton, changeNumButton1, changeNumButton2, backButtonToButtonScene1);
